...
namespace QLTT.Controllers
{
    public class HomeController : Controller
    {
     ...
     .ToList(); // Now we have a list of objects in memory

                li = db.Sans.AsEnumerable() // Switch to LINQ to Objects for the rest of the operations
        ...
        public ActionResult TimSan(string id)
        {
            ...
            //double averageRating = CalculateAverageRating(dstn);
        ...
        public ActionResult Result(String maKH, String ngayThue, int soGioThue, String maSan)
        {
            ...
            else
            {
                ...
                tgd.NgayThue = DateTime.ParseExact(ngayThue, "MM/dd/yyyy", CultureInfo.InvariantCulture).AddHours(12);
